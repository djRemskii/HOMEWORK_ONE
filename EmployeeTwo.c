...
//static function == only useable in this file! basically java's "private"
...
{ 
    printf("%d\n", strcmp((char *) targetPtr, tableValuePtr->phone));
...
{ 
    printf("%d\n", * (double *) targetPtr != tableValuePtr->salary);
